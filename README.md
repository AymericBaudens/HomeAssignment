...
## Caveats
This walkthrough is intended to demonstrate how easy and fast it is to deploy and observe a managed Kafka service. Additional steps would be needed for production grade services, which would mainly consist of enabling additional built-in security features, such as account management, IP whitelisting, etc…

## Fast Track
If you don't want to read all this article, a **terraform** file is provided in the terraform folder of this repository for a "fast track" setup, putting everything in place at once. All you will need additionally is a token that you can create in your "account" section. Further readings about Aiven terraform provider available [here](https://registry.terraform.io/providers/aiven/aiven/latest/docs)
For the others, let's create the environment step by step through the UI, here we go...

## Create your managed kafka service
Once connected on the Aiven console, click the "create service" red button, upper right, and choose Apache Kafka.
...
We will use *KafkaProducer* python lib to push messages in our demo topic. We will first instantiate our *producer* with the info retrieved earlier at service creation: **service URI, and path** to *ca.pem*, *service.cert* and *service.key* files.
...
InfluxDB service is now receiving metrics from our Kafka service, and pushing them into a Grafana Dashboard.
...
**That's it! In a few click, with nothing more than an Aiven account, we've created a fully operational Kafka service, running on a given clouder infrastructure, and observed thanks to Aiven native services integrations**


## To go further
https://aiven.io/kafka
https://docs.aiven.io/docs/products/kafka/getting-started
https://docs.aiven.io/docs/products/grafana/get-started
